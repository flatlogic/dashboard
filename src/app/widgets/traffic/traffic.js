(function() {
    ...
    var trafficModule = angular.module('qorDash.widget.traffic')
            .directive('qlTraffic', qlTraffic)
        ;
    qlTraffic.$inject = ['d3', '$window', '$interval', '$compile', '$rootScope'];
    function qlTraffic(d3, $window, $interval, $compile, $rootScope) {
        return {
            restrict: 'EA',
            scope: {},
...
// Used when temporarily disabling user interractions to allow animations to complete
                        ...
                        tooltip = d3.select(element[0]).append("div").attr("id", "tooltip");
